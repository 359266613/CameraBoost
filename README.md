...
### 1. CamElapsed+ 
https://github.com/PoomSmart/CamElapsedPlus
- **功能**: 为视频录制计时器添加亚秒显示
- **特性**: 支持 1-3 位小数精度的时间显示
- **用途**: 提供更精确的录制时间信息

### 2. Record 'n' Torch
https://github.com/PoomSmart/Record--n--Torch
- **功能**: 在录制视频时控制闪光灯
- **特性**: 录制过程中可以开关闪光灯
- **用途**: 提供更好的照明控制

### 3. RecordPause
https://github.com/PoomSmart/RecordPause
- **功能**: 暂停和恢复视频录制
- **特性**: 无需停止录制即可暂停
- **用途**: 分段录制，提高录制灵活性

### 4. TapVideoConfig 
https://github.com/PoomSmart/TapVideoConfig
- **功能**: 直接在相机应用中更改视频配置
- **特性**: 支持多种分辨率和帧率设置
- **用途**: 快速调整录制参数
